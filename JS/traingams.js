...
let containerLevel1 = document.querySelector(".containerTrain");
let countReady = document.querySelector(".count");
let TrainIndex = 0;
let congradulation = document.querySelector(".congradulation");

let levels = [
  {
    levelNum: "Level 1",
    img: "image/Games/L_Train/1.jpg",
    questions: [
      {
        title: "What is the color of the jacket the girl is wearing?",
        answers: [
          { text: "Red" },
      ...
      {
        title: "Was there a cat in the picture?",
        answers: [{ text: "Yes" }, { text: "No", isCorrect: true }],
        labelName: "q2",
      },
      {
        title: "How was the weather in the picture?",
        answers: [
          { text: "Sunny" },
          { text: "Snowy" },
  ...
  {
    levelNum: "Level 2",
    img: "image/Games/L_Train/2.jpg",
    questions: [
      {
        title: "How many dinosaurs are in the picture?",
        answers: [{ text: "4" }, { text: "5", isCorrect: true }, { text: "6" }],
        labelName: "q4",
      },
      {
        title: "Was there a bee in the picture?",
        answers: [{ text: "Yes" }, { text: "No", isCorrect: true }],
        labelName: "q5",
      },
      {
        title: "Was there a child in the picture?",
        answers: [{ text: "Yes" }, { text: "No", isCorrect: true }],
        labelName: "q6",
      },
    ],
  ...
  {
    levelNum: "Level 3",
    img: "image/Games/L_Train/3.jpg",
    questions: [
      {
        title: "How many candles on the cake?",
        answers: [{ text: "4" }, { text: "5", isCorrect: true }, { text: "6" }],
        labelName: "q4",
      },
      {
        title: "Were there gifts on the table?",
        answers: [{ text: "Yes" }, { text: "No", isCorrect: true }],
        labelName: "q5",
      },
      {
        title: "Was there a child wearing a celebration hat?",
                ...
                if (questionIndex < level.questions.length - 1) {
                  ...
                  setTimeout(() => {
                    ...
                    if (TrainIndex < levels.length) {
                      ...
                      containerLevel1.innerHTML = "";
                      congradulation.classList.remove("d-none");
                    }
                  }, 1000);
                }
              }, 2000);
